...
for single_row in range(statSummary.shape[0]):
    ...
    distVectSame, distAngSame, distCombineSame = tom_pdist_All2One(transVectSame, transRotSame, 
                                                                   avgShift, avgRot, 
    ...
    distVectDiff, distAngDiff, distCombineDiff = tom_pdist_All2One(transVectDiffAll, transRotDiffAll, 
                                                                   avgShift, avgRot, 
                                                                   worker_n = 1, gpu_list = None, 
                                                                   cmb_metric = 'scale2Ang', pruneRad = 100)
