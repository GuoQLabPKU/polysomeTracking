...
def tom_pdist_All2One(transVect, transAng, shift, rot, 
                      worker_n = 1, gpu_list = None, 
                      cmb_metric = 'scale2Ang', pruneRad = 100):
    '''
    TOM_PDIST_ALLL2ONE is aimed to calculate the distance between 
...
def getDist(transVect, transAng,worker_n, gpu_list,
                   cmb_metric, pruneRad):  
